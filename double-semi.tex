...
In other words, $\mathbf{OrdSemiCatAct}$ is small half-ordered semicategories together with a function~$\supfun{}$ to $\mathbf{Pos}$ with morphisms being a monotone semifunctors~$F$ together with a function~$G$ conforming to the identities:
\begin{enumerate}
