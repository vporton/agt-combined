...
\begin{abstract}
I introduce \emph{ordered semicategory actions} and \emph{ordered semigroup actions} in mathematical vernacular with the purpose to use them in general topology. A wide class of ordered semigroup actions are a embedded into an algebraic variety.
\end{abstract}
