...
\begin{defn}
The morphisms of the category $\mathbf{Act^{\ast}SemiCatIden}$ of actionable semicategories with identities are semifunctors that are both morphisms of $\mathbf{OrdAct^{\ast}SemiCat}$ under the conditions that: $\supfun{\id_p}=x\sqcap p$.
\end{defn}
...
\begin{obvious}
If it is an ordered actionable semicategory, then the result is a semicategory action with identities.
\end{obvious}
