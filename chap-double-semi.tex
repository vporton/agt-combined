...
\begin{prop}
The above with the same semigroup operation~$\circ$ defines an actionable semicategory with identities.
\end{prop}
...
Identities are the same, because the~$\circ$ operation is the same.
