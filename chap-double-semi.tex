...
My research~\cite{volume-1} shows that all kinds of spaces met in general topology ((pre-)topological spaces, (quasi-)metric spaces, (quasi-)proximity spaces, (quasi-)uniform spaces, locales and frames, Cauchy spaces) are embedded into ordered semicategory actions.
