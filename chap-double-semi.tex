...
\begin{itemize}
\item small ordered semicategories with a semifunctor \[ \supfun{}:\mathbf{OrdSemiCat}\to\mathbf{Pos} \] conforming to the identity $a\sqsubseteq b\Rightarrow\supfun{a}x\sqsubseteq\supfun{b}x$ as objects;
