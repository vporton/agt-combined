...
\item $\id_a\cdot(\id_b\cdot c) = \id_{\id_a\cdot b}\cdot c$; ($\sqcap$-semilattice)
\item $\id_a\cdot b = \id_b\cdot a$; (ditto)
\item $\id_a\cdot a = a$; (ditto)
\item $(\id_{g_0}\cdot g_1)\circ(\id_{f_0}\cdot f_1) = \id_{\id_{g_0}\cdot g_1}\cdot((\id_{g_0}\cdot g_1)\circ(\id_{f_0}\cdot f_1))$ (ordered semigroup);
\item $(\id_{g_0}\cdot g_1)\cdot(\id_{f_0}\cdot f_1) = \id_{\id_{g_0}\cdot g_1}\cdot((\id_{g_0}\cdot g_1)\cdot(\id_{f_0}\cdot f_1))$ (ordered actionable semigroup).
\end{enumerate}
