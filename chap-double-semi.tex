...
\begin{itemize}
\item small ordered semicategories together with semifunctors \[ \supfun{}:\mathbf{OrdSemiCat}\to\mathbf{Pos} \] conforming to the identity $a\sqsubseteq b\Rightarrow\supfun{a}x\sqsubseteq\supfun{b}x$ as objects;
\item monotone semifunctors between them as morphisms.
\end{itemize}
