...
\fxnote{Define the category of semicategory actions with identities.}
...
\begin{proof}
\begin{description}
\item Denote $F$ the functor that maps an object $(A,\circ,\supfun{})$ to $(A,\circ,\supfun{}')$ and a morphism ?? to ??.
\end{description}
\end{proof}
