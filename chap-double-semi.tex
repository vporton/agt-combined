...
\begin{proof}
Denote $\Phi$ the functor that maps an object $(\mathcal{C},\circ,\supfun{})$ to $(\mathcal{C},\circ,\supfun{}')$ and a morphism $(1,G)$ to $(1,p\mapsto\id_p)$ and $\Psi$ the unique functor that maps an object $(\mathcal{C},\circ,\supfun{}')$ to $(\mathcal{C},\circ,\supfun{})$ and a morphism $(1,G)$ to $(1,\id_p\mapsto p)$ ($p\mapsto\id_p$ is an injection). It's obvious, that $\Phi$ and $\Psi$ are inverse to each other.
\end{proof}
