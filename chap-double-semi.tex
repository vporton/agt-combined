...
Every semicategory action with identities induces an actionable semicategory with identities, which induces another semicategory action with identities. Thus every semigroup with identities induces another semigroup with identities.

\fxnote{What happens if we apply this ``inducing'' two times?}