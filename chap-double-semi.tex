...
\begin{defn}
The category~$\mathbf{SemiOrdSemiCatAct}$ of \emph{semi-ordered semicategory actions} is small ordered semicategories with semifunctors between them as morphisms and a semifunctor \[ \supfun{}:\mathbf{OrdSemiCat}\to\mathbf{Pos} \] with the identity $a\sqsubseteq b\Rightarrow\supfun{a}x\sqsubseteq\supfun{b}x$.
...
$\mathbf{OrdSemiCat}$ semifunctor
\[ \supfun{}:\mathbf{OrdSemiCat}\to\mathbf{Pos} \]
with with the identities $a\sqsubseteq b\Rightarrow\supfun{a}x\sqsubseteq \supfun{b}x$ and $x\sqsubseteq y\Rightarrow\supfun{a}x\sqsubseteq\supfun{a}y$.
