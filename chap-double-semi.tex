...
\begin{defn}
The category~$\mathbf{SemiOrdSemiCatAct}$ of semi-ordered semicategory actions is small semi-ordered semicategories with monotone semifunctors between them as morphisms with the identity
$\supfun{b\circ a}=\supfun{b}\circ\supfun{a}$.
...
\begin{defn}
The category~$\mathbf{OrdSemiCatAct}$ of ordered semicategory actions is
