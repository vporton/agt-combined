...
\fxwarning{I should replace ``semifunctor'' by ``semifunctor'' in old texts.}
...
\begin{defn}
The category~$\mathbf{SemiOrdSemiCatAct}$ of semi-ordered semicategory actions ??
\end{defn}

\begin{defn}
The category~$\mathbf{OrdSemiCatAct}$ of ordered semicategory actions ??
\end{defn}
