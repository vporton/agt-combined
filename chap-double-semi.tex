...
\begin{defn}
The category~$\mathbf{SemiOrdSemiCatAct}$ of \emph{semi-ordered semicategory actions} is small ordered semicategories with semifunctors between them as morphisms and a full faithful functor \[ \supfun{}:\mathbf{SemiCat}\to\mathbf{Pos} \] with the identities:
\begin{enumerate}
