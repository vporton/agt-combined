...
\begin{thm}
If we restrict the~$\cdot$ operation to the set that $\setcond{\id_x}{x\in A,A\in\Ob}$, then we recover the original semicategory action \fxnote{with identities?} up to isomorphism.
\end{thm}
