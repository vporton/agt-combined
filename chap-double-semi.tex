...
\begin{defn}
An \emph{actionable semicategory with identities} is an ordered actionable semicategory that is also a semicategory with identities.
\end{defn}
...
\begin{rem}
An actionable ordered semigroup\fxnote{Define!} is an relational algebra scheme.
\end{rem}

\begin{rem}
It is even an universal algebra scheme in the case of up or down semilattice.
See \url{https://chatgpt.com/s/t_691e8f88da64819184591f9e310e1728} for its properties.
\end{rem}
