...
TexMacs file {\tt reloid-union-distr.tm} file contains unchecked proof of
$f\circ\bigsqcup K=\bigsqcup_{g\in K}(g\circ f)$ for complete reloid~$f$.
...
Define for OSA $\suprel{}$ by the formula $\suprel{g\circ a\circ f}=\supfun{g}\circ\suprel{a}\circ\supfun{f^{-1}}$.
