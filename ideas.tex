...
\href{https://www.math.md/files/basm/y2013-n2-3/y2013-n2-3-(pp37-46).pdf.pdf}{Selected Old Open Problems in General Topology}{}
...
Another way to generalize OSA is $(s,\cdot,\cdot')$, where we obtain $g\cdot'f=i(g\cdot f)$.
...
\url{https://www.researchgate.net/publication/315509634_On_uniformly_discrete_subsets_in_uniform_spaces_and_topological_groups?_tp=eyJjb250ZXh0Ijp7ImZpcnN0UGFnZSI6ImhvbWUiLCJwYWdlIjoicHVibGljYXRpb24ifX0}

Express group inverse operation through~$\cdot$ actionable semigroup operation.
This reduces groups to ordered semigroup actions (and explains why groups and OSAs are so similar).

\url{https://en.wikipedia.org/wiki/Semi-continuity} -- a kind of continuity.

\section{Category theory}

The OSA may be often restored from an ordered category
by making the actions act on subobjects of categorical identity.
...
``What you call "semifunctors" are more commonly known as semifunctors.''
