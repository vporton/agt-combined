...
\begin{defn}
\index{semicategory!with star-morphisms}\index{semicategory!with star-morphisms}A
\emph{semicategory with star-morphisms} consists of
\begin{enumerate}
\item a semicategory $C$ (\emph{the base semicategory});
...
\end{defn}
(Having fixed a semicategory with star-morphisms) I will denote $\StarHom(P)$
...
is a semicategory with star-morphisms whose base is a category and
...
\begin{defn}
\index{semicategory!partially ordered!with star-morphisms}A \emph{partially
ordered semicategory with star-morphisms} is a category with star-morphisms,
whose base semicategory is a partially ordered semicategory and every
...
with star-morphisms which is also a partially ordered semicategory
with star-morphisms.
\end{defn}

\begin{defn}
\index{semicategory!with star-morphisms!quasi-invertible}A \emph{quasi-invertible}
semicategory with star-morphisms is a partially ordered semicategory
with star-morphisms whose base semicategory is a quasi-invertible semicategory,
such that for every index set $n$, star-morphisms $a$ and $b$ of
arity $n$, and an $n$-indexed family $f$ of morphisms of the base
semicategory it holds 
\[
...
category with star-morphisms is a quasi-invertible semicategory with
...
\begin{defn}
\index{semicategory!with star-morphism!induced by dagger semicategory}Semicategory
with star morphisms \emph{induced} by a dagger semicategory $C$ is: 
\begin{itemize}
...
\end{itemize}
\end{defn}
Let prove it is really a semicategory with star-morphisms.
\begin{proof}
...
above defined semicategory with star-morphisms.
\end{defn}
...
\begin{defn}
The abrupt partially ordered semicategory of a partially ordered semicategory
with star-morphisms is the abrupt semicategory with the following order
of morphisms: 
\begin{itemize}
\item Indexed (by $\arity m$ for some $m\in M$) families of morphisms
of $C$ are ordered as function spaces of posets.
\item Star-morphisms (which are morphisms $\None\rightarrow\Obj_{m}$ for
some $m\in M$) are ordered in the same order as in the semicategory
with star-morphisms.
...
\end{itemize}
\end{defn}
We need to prove it is a partially ordered semicategory.
\begin{proof}
It trivially follows from the definition of partially ordered semicategory
with star-morphisms.
\end{proof}
...
compositions form a quasi-invertible semicategory with star-morphisms.\end{thm}
\begin{rem}
It seems that this semicategory with star-morphisms isn't a category with star-morphisms.\end{rem}
\begin{proof}
We need to prove:
\begin{enumerate}
