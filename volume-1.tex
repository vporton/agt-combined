...
\usepackage{agt}
\hypersetup{pdftitle={General Topology as Ordered Semigroup Actions. Book 1},
...
The author is seeking opportunities for academic collaboration or a position as a researcher/visiting professor. Main interests: general topology through ordered semicategory actions, discontinuous analysis, Web3 apps (including science financing mechanisms). Open to collaborations and lectures. Contact: \href{mailto:mailto:porton.victor@gmail.com}{porton.victor@gmail.com}.
...
\part{Ordered semicategory actions}

This part is somehow poorly written, because the book is in process of a rewrite (namely, reducing all the below topics to ordered semicategory actions\footnote{For a definition of ordered semicategory actions see below.}).
