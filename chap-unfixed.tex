...
is a semifunctor.
\item\label{s-fcd-unfix} $\mathscr{S}$ from unfixed funcoids is an order embedding and a semifunctor (=~semigroup homomorphism).
\end{enumerate}
\end{prop}
...
is a semifunctor.
\item\label{s-rld-unfix} $\mathscr{S}$ from unfixed reloids is an order embedding and a semifunctor (=~semigroup homomorphism).
\end{enumerate}
\end{prop}
...
That it is a semifunctor easily follows from the above.
