...
\begin{defn}
\emph{Semiordered semicategory action} is a function~$\supfun{}$ (\emph{action}) from a semicategory objects and morphisms to the category~$\mathbf{Pos}$, such that
\begin{enumerate}
...
\begin{defn}
\emph{Ordered semicategory action} is a function~$\supfun{}$ (\emph{action}) from a semicategory objects and morphisms to the category~$\mathbf{Pos}$, such that
\begin{enumerate}
\item $a\sqsubseteq b\Rightarrow\supfun{a}x\sqsubseteq \supfun{b}x$ for all $a,b\in S$, $x\in\mathfrak{A}$;
