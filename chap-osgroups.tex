...
\begin{defn}
\emph{Ordered semicategory action} is an ordered semicategory action with the property
\begin{enumerate}
...
Skip reading this chapter, because it's ``unripe'' (the ideas may be completely wrong). \href{https://chatgpt.com/share/6a80a2aa-2b90-83eb-b184-0f0c582c1c8b}{Some ideas by ChatGPT.}

\fxwarning{Usefulness of this is dubious: I just define \emph{some} embedding that may be useless.}

Geometric spaces: Euclidean spaces, projective spaces, Hilbert spaces, vector spaces\fxerror{Not sure about vector spaces, see \href{https://chatgpt.com/share/6a664534-7484-83eb-864f-3999115d07a2}{ChatGPT            }.}, have a symmetry group~$G$, that is a group~$G$ together with its action on a set~$\subsets\mho$. \fxnote{Also consider Banach spaces.}
...
\setcond{\setcond{\supfun{f}x}{f\in G}}{x\in X}
\]
that is
\[
\supfun{G'}X=\setcond{\setcond{\supfun{f}x}{f\in G}}{x\in X}
\]
