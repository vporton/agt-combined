...
In~\cite{important} I argue that ordered semicategory actions (together with below defined \emph{funcoids}) are as important as groups, with the main distinctiont that discovery of ordered semicategory action was delayed.
