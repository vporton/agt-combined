...
To define compactness\footnote{See this draft for the reasoning that for topological spaces it coincides with the standard definition: \url{https://mathematics21.com/binaries/addons.pdf}.} we additionally need the structure of filtrator $(\mathfrak{A},\mathfrak{Z})$ on our poset. Then it is space~$a$ is \emph{directly compact} iff
