...
\begin{defn}
\emph{Funcoidal element (of ordered dagger semicategory with involution)} is such an element~$f$ that \[ \forall x,y:(y\nasymp\supfun{f}x\Leftrightarrow x\nasymp\supfun{f^\dagger}y). \]
\end{defn}

Funcoidal element in an obvious way determines a pointfree funcoid.
