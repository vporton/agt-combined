...
\begin{defn}
\index{filter!on a set}A filter on a set $\mho$ is a $\mathcal{F}\in\subsets\subsets\mho\setminus\{\emptyset\}$
such that:
\begin{enumerate}
...
\begin{defn}
\index{filtrator!primary}\emph{Primary filtrator} is a filtrator
...
\begin{thm}
A filtrator $(\mathfrak{A},\mathfrak{Z})$ is primary iff $\forall a\in\mathfrak{A}:a=\bigsqcap^{\mathfrak{A}}\up a$.\end{thm}
\begin{proof}
~
\begin{description}
...
as it is primary $a\sqsupseteq b$.
\end{description}
\end{proof}

\begin{thm}
A filtrator is primary iff it is isomorphic to the filtrator consisting of the set of filters on a poset and the set of principal filters on this poset.
\end{thm}
...
\item[$\Rightarrow$] Let filtrator $((\mathfrak{A},{\sqsubseteq}),\mathfrak{Z})$ be primary.

$((\mathfrak{A},{\sqsubseteq}),\mathfrak{Z})$ is isomorphic to $((\rsupfun{\up}\mathfrak{A},{\supseteq}),\rsupfun{\up}\mathfrak{Z})$ by the isomorphism $(x,{\sqsubseteq})\mapsto(\up x,{\supseteq})$. It is an isomorphism between $(\mathfrak{A},{\sqsubseteq})$ and $(\rsupfun{\up}\mathfrak{A},{\supseteq})$ because $((\mathfrak{A},{\sqsubseteq}),\mathfrak{Z})$ is primary. Next, it is obvious that this function an isomorphism between the filtrators.

$\up x$ is a filter, because
\[
  a, b \in \up x \Leftrightarrow a, b \sqsupseteq x \Leftrightarrow
  \up a, \up b \subseteq \up x \Leftrightarrow \up a
  \cup \up b \subseteq \up x \Leftrightarrow \up a \sqcap
  \up b \sqsupseteq \up x.
\]
So, $((\rsupfun{\up}\mathfrak{A},{\supseteq}),\rsupfun{\up}\mathfrak{Z})$ is a filtrator of filters on the poset~$\mathfrak{Z}$.
\end{widedisorder}
\end{proof}
...
\begin{obvious}
Every primary filtrator is prefiltered.
\end{obvious}
...
is a primary filtrator.\end{obvious}
\begin{defn}
...
\item [{\ref{semifilt-joinclosed-f}$\Rightarrow$\ref{semifilt-joinclosed-conc}}] Let
$(\mathfrak{A},\mathfrak{Z})$ be a primary filtrator. Let $S\in\subsets\mathfrak{Z}$
...
\item \label{cor-less-flt}$a$ is an element of a primary filtrator and
$\Cor a$ exists.
...
\item \label{cor-eq-filt}$a$ is an element of a primary filtrator and
...
join-closed core because it is primary  . So $\Cor'a\sqsubseteq\Cor a$.
...
\item \label{atom-both-f}$(\mathfrak{A},\mathfrak{Z})$ is a primary filtrator over a meet-semilattice.
...
\item [{\ref{atom-both-f}$\Rightarrow$\ref{atom-both-conc}}]
It is filtered
